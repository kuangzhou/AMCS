function [fitness]=CostFunction(Position,lab_tr,lab_ts,train_data,test_data,Distr)
j=1;fea_tr=[];fea_ts=[];
...
% [I,hypo,tserr,Kscore_ts]=C4_5(fea_tr',lab_tr',fea_ts',lab_ts',cn);
[I,hypo,tserr,Kscore_ts]=DGC(fea_tr,lab_tr,fea_ts,lab_ts,Distr);
