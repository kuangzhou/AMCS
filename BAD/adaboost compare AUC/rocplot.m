%function [auc auh acc0 accm thrm thrs acc sens spec hull] = rocplot(scores, classes, plottype, Nthr)
function [auc]= rocplot(scores, classes, plottype, Nthr)
...
switch plottype
    ...
    case 1 % standard TPR (= sens) vs FPR (= 1-spec)
       ...
       % hold on
        plot(1-spec0,sens0,'r.-', 1-specm,sensm,'bo',[0 1],[0 1],'k');
