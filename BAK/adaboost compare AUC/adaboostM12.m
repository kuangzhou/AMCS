% adaboost.M1
 ...
 function [trerr, tserr, w,avgscore_ts,ts_res,rate] = adaboostM12(type, fea_tr, lab_tr, fea_ts, lab_ts, M, cn)
...
%-----------------------for KNN, it requires only one step-----------------
         [I_tr, hypo_tr,rate_tr,score_tr(:,:,m)] = KNN(fea_w, lab_w, fea_tr, lab_tr,5,'Euclidean');        % train on training set
         [I_ts, hypo_ts,rate_ts,score_ts(:,:,m)] = KNN(fea_w, lab_w, fea_ts, lab_ts,5,'Euclidean'); % train on testing set
