...
% [I,hypo,trerr,Kscore_tr1]=KNN3(fea_tr,lab_tr,fea_tr, lab_tr,5,'Euclidean');
% [I,BKhypo,tserr,Kscore_ts1]=KNN3(fea_tr,lab_tr,fea_ts,lab_ts,5,'Euclidean');
% [I,BKhypo,tserr1,Kscore_ts1,tsrate1]=RBF(fea_tr,lab_tr,fea_ts,lab_ts);
[I,BKhypo,tserr1,Kscore_ts1,tsrate1]=C4_5(fea_tr',lab_tr',fea_ts',lab_ts',cn);
% [I,Khypo,trerr,Kscore_tr1]=RBF(fea_tr,lab_tr,fea_tr, lab_tr);
...
% [I,hypo,trerr,Kscore_tr]=KNN3(fea_tr,lab_tr,fea_tr, lab_tr,5,'Euclidean');
% [I,Khypo,tserr,Kscore_ts]=KNN3(fea_tr,lab_tr,fea_ts,lab_ts,5,'Euclidean');
% [I,hypo,trerr,Kscore_tr]=RBF(fea_tr,lab_tr,fea_tr, lab_tr);
% [I,Khypo,tserr,Kscore_ts,tsrate]=RBF(fea_tr,lab_tr,fea_ts, lab_ts);
[I,Khypo,tserr,Kscore_ts,tsrate]=C4_5(fea_tr',lab_tr',fea_ts', lab_ts',cn);
